...
//
////        NativeWebcamDriver driv = new NativeWebcamDriver();
////        NativeWebcamDevice dev = new NativeWebcamDevice();
////
////        List<Webcam> webcams = Webcam.getWebcams();
////        webcam.
////
////        Dimension[] sizes = new Dimension[] {new Dimension(1920,1080)};
////        webcams.get(0).setCustomViewSizes(sizes);
